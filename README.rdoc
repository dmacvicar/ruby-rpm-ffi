...
* Is pure ruby
* Is documented
* We target the current stable rpm for now (4.9). Still supporting at least
  the Enterprise distros rpm versions is a goal.
...
* RPM::DB will be different, as modern rpm APIs do
